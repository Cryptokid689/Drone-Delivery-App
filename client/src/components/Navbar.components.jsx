...
function Navbar() {
    ...
    return <nav class="sidebar dark_sidebar">
    ...
    <ul id="sidebar_menu" class="metismenu">
        <li class="">
            <a class="has-arrow" href aria-expanded="false">
                <div class="nav_icon_small">
                    <img src="img/menu-icon/1.svg" alt="pic" />
                </div>
                <div class="nav_title">
                    <span>Dashboard </span>
                </div>
        ...
        <li class="">
            <a href="crypto_wallet.html" aria-expanded="false">
                <div class="nav_icon_small">
                    <img src="img/menu-icon/2.svg" alt="pic" />
                </div>
                <div class="nav_title">
        ...
        <li class="">
            <a href="buy_sell.html" aria-expanded="false">
                <div class="nav_icon_small">
                    <img src="img/menu-icon/3.svg" alt="pic" />
                </div>
                <div class="nav_title">
                    <span>Buy &amp; Sell</span>
                </div>
        ...
        <li class="">
            <a href="Trader_Profile.html" aria-expanded="false">
                <div class="nav_icon_small">
                    <img src="img/menu-icon/4.svg" alt="pic" />
                </div>
                <div class="nav_title">
        ...
        <li class="">
            <a href="crypto_stats.html" aria-expanded="false">
                <div class="nav_icon_small">
                    <img src="img/menu-icon/5.svg" alt="pic" />
                </div>
                <div class="nav_title">
        ...
        <li class="mm-active">
            <a class="has-arrow" href aria-expanded="false">
                <div class="nav_icon_small">
                    <img src="img/menu-icon/6.svg" alt="pic" />
                </div>
                <div class="nav_title">
            ...
            <ul class="mm-collapse mm-show">
                ...
                <li><a href="Payment_details.html" class="active">Payment details</a></li>
            </ul>
        </li>
        <li class="">
            <a class="has-arrow" href aria-expanded="false">
                <div class="nav_icon_small">
                    <img src="img/menu-icon/7.svg" alt="pic" />
                </div>
                <div class="nav_title">
                    <span>Tickers</span>
                </div>
        ...
        <li class="">
            <a class="has-arrow" href aria-expanded="false">
                <div class="nav_icon_small">
                    <img src="img/menu-icon/8.svg" alt="pic" />
                </div>
                <div class="nav_title">
                    <span>Apps </span>
                </div>
        ...
        <li class="">
            <a class="has-arrow" href aria-expanded="false">
                <div class="nav_icon_small">
                    <img src="img/menu-icon/Pages.svg" alt="pic" />
                </div>
                <div class="nav_title">
                    <span>Pages</span>
                </div>
        ...
        <li class="">
            <a class="has-arrow" href aria-expanded="false">
                <div class="nav_icon_small">
                    <img src="img/menu-icon/General.svg" alt="pic" />
                </div>
                <div class="nav_title">
                    <span>General</span>
                </div>
        ...
        <li class="">
            <a class="has-arrow" href aria-expanded="false">
                <div class="nav_icon_small">
                    <img src="img/menu-icon/Mail_Box.svg" alt="pic" />
                </div>
                <div class="nav_title">
                    <span>Mail Box </span>
                </div>
        ...
        <li class="">
            <a class="has-arrow" href aria-expanded="false">
                <div class="nav_icon_small">
                    <img src="img/menu-icon/icon.svg" alt="pic" />
                </div>
                <div class="nav_title">
                    <span>Icons</span>
                </div>
        ...
        <li class="">
            <a class="has-arrow" href aria-expanded="false">
                <div class="nav_icon_small">
                    <img src="img/menu-icon/18.svg" alt="pic" />
                </div>
                <div class="nav_title">
        ...
        <li class="">
            <a class="has-arrow" href aria-expanded="false">
                <div class="nav_icon_small">
                    <img src="img/menu-icon/forms.svg" alt="pic" />
                </div>
                <div class="nav_title">
                    <span>forms</span>
                </div>
        ...
        <li class="">
            <a class="has-arrow" href aria-expanded="false">
                <div class="nav_icon_small">
                    <img src="img/menu-icon/14.svg" alt="pic" />
                </div>
                <div class="nav_title">
                    <span>Widgets</span>
                </div>
        ...
        <li class="">
            <a class="has-arrow" href aria-expanded="false">
                <div class="nav_icon_small">
                    <img src="img/menu-icon/17.svg" alt="pic" />
                </div>
                <div class="nav_title">
                    <span>Table</span>
                </div>
        ...
        <li class="">
            <a class="has-arrow" href aria-expanded="false">
                <div class="nav_icon_small">
                    <img src="img/menu-icon/16.svg" alt="pic" />
                </div>
                <div class="nav_title">
                    <span>Charts</span>
                </div>
        ...
        <li class="">
            <a class="has-arrow" href aria-expanded="false">
                <div class="nav_icon_small">
                    <img src="img/menu-icon/map.svg" alt="pic" />
                </div>
                <div class="nav_title">
                    <span>Maps</span>
                </div>
