        ...
        <section class="profile-section">
            <div class="main_content_iner overly_inner ">
                <div class="container-fluid p-0 ">
                    ...
                    <div class="row">
                        <div style={{height: "85vh"}} class="col-lg-3 ">
                            <div style={{...centerStyle, flexDirection: "column"}} class="white_card card_height_100">
                        ...
                        <div class="col-lg-9">
                            <div style={{...centerStyle, flexDirection: "column"}} class="white_card card_height_100 mb_30">
